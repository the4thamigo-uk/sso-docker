...
export SSO_DOCKER_NGINX_NAME=${PREFIX}nginx
export SSO_DOCKER_OPENSSH_NAME=${PREFIX}openssh
...
# openssh config
export SSO_DOCKER_OPENSSH_PORT=${SSO_DOCKER_OPENSSH_PORT:-22}
export SSO_DOCKER_OPENSSH_PORT_INT=${SSO_DOCKER_OPENSSH_PORT_INT:-$(expr $SSO_DOCKER_PORT_BASE + 22)}
export SSO_DOCKER_OPENSSH_USER=${SSO_DOCKER_OPENSSH_USER:-ssotest@miracl.com}
export SSO_DOCKER_OPENSSH_IP=${SSO_DOCKER_OPENSSH_IP:-172.16.0.100}

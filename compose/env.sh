...
export SSO_DOCKER_BROWSER_NAME=${PREFIX}browser
...
export SSO_DOCKER_BROWSER_PORT=${SSO_DOCKER_BROWSER_PORT:-$(expr $SSO_DOCKER_PORT_BASE + 6)}
...
export SSO_DOCKER_BROWSER_BASEURL=${SSO_DOCKER_BASEURL}:${SSO_DOCKER_BROWSER_PORT}
